...
method calcMethod = all; //specify type of calculation method
...
int main() {
    ...
    if (calcMethod == brute) {
        ...
        string fileName = "S" + c + "_askhachadoorian.sol";
        ...
        //create file name
        c = to_string(cost);
        fileName = "S" + c + "_askhachadoorian.sol";
...
int bruteForce(vector<vector<int> > &graph, vector<int> &path, int numNodes) { 
    ...
    //set up variables
    int minCost; //variable to hold the shortest total distance
